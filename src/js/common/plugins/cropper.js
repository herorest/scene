...
(function (factory) {
  ...
  $.extend(prototype, {
    ...
    load: function (url) {
      ...
      this.$clone = $clone = $('<img src="' + (bustCacheUrl || url) + '">');
  ...
  $.extend(prototype, {
    ...
    initCanvas: function () {
      var container = this.container;
	  var containerWidth = parseInt(this.options.orginal.canvas.width);
	  var containerHeight = parseInt(this.options.orginal.canvas.height);
      ...
      canvas.oldLeft = canvas.left = parseInt(this.options.orginal.canvas.left);
      canvas.oldTop = canvas.top = parseInt(this.options.orginal.canvas.top);
    ...
    initCropBox: function () {
      ...
      var cropBox = {
            width: options.orginal.crop.width || canvas.width,
            height: options.orginal.crop.height || canvas.height
          };
	  ...
	  cropBox.oldLeft = cropBox.left = parseInt(this.options.orginal.crop.left);
      cropBox.oldTop = cropBox.top = parseInt(this.options.orginal.crop.top);
