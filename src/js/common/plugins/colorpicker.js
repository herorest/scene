...
(function(window, document, undefined) {
    ...
    var colorpickerHTMLSnippet = [
        ...
        '<div class="color-picker_wrapper">',
    ...
    function ColorPicker(slideElement, pickerElement, callback) {
        ...
        if (!callback) {
            ...
            this.slideElement = element.getElementsByClassName('color_slide')[0];
            this.pickerElement = element.getElementsByClassName('color_picker')[0];
            var slideIndicator = element.getElementsByClassName('color_slide_indicator')[0];
            var pickerIndicator = element.getElementsByClassName('color_picker_indicator')[0];
