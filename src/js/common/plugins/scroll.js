    ...
    init:function(opts){
        ...
        _addEvent(document,'mousedown',function(e){
            ...
            if(target == _this.vScroll || target == _this.lScroll){
                ...
                _addEvent(document,'mousemove',mousemoveHandle);
                _addEvent(document,'mouseup',function(){_removeEvent(document,'mousemove',mousemoveHandle)});
            };
